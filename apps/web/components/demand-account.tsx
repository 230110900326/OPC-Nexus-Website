...
export function DemandAccount() {
  ...
  return <main className="demand-account-page">
    <header className="account-sub-header"><Link className="auth-brand" href="/"><span>OPC</span> NEXUS</Link><div className="account-header-actions"><Link href="/">← 返回首页</Link><Link href="/account">个人资料</Link><Link href="/account/posts">我的讨论</Link><Link href="/demands">需求广场</Link><Link className="demand-primary" href="/demands/new">发布需求 →</Link></div></header>
