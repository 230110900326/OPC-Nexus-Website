export type HeatInput = {
  ...
  sourceTrust: number; editorScore: number; contentType: "article" | "policy" | "video" | "post";
  externalViewPercentile?: number; externalLikePercentile?: number;
};

const HALF_LIFE: Record<HeatInput["contentType"], number> = { article: 48, policy: 168, video: 72, post: 24 };
