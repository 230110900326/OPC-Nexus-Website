...
export class Article {
  ...
  @Column({ type: "text", default: "" }) content!: string; @Column({ name: "canonical_url", type: "varchar", length: 1000, nullable: true }) canonicalUrl!: string | null; @Column({ name: "content_fingerprint", type: "varchar", length: 64, nullable: true }) contentFingerprint!: string | null;
