...
export class ForumService {
  ...
  async detail(id: string) {
    ...
    await Promise.all([this.posts.increment({ id }, "viewCount", 1), this.ranking.recordDelta(MetricContentType.POST, id, { readCount: 1 })]); post.viewCount += 1;
