...
describe("InteractionsService", () => {
  ...
  const service = new InteractionsService(likes, favorites, follows, articles, posts, comments, users, videos, creators, demands, { inspect: jest.fn().mockResolvedValue({ allowed: true, reason: null }) } as never, { recordDelta: jest.fn() } as never, { create: jest.fn() } as never);
