import { Controller, Delete, Get, Param, ParseEnumPipe, ParseUUIDPipe, Post, Req, UseGuards } from "@nestjs/common";
...
export class InteractionsController {
  ...
  private context(request: Request) { return { ip: request.ip, device: request.header("x-device-id") ?? request.header("user-agent") ?? undefined }; }
}
