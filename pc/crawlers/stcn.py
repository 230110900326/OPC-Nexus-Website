...
class StcnCrawler(BaseCrawler):
    ...
    def __init__(self):
        super().__init__()
        self.source_name = "证券时报"
        self.base_url = "https://www.stcn.com"

        # 主要频道
        self.channels = [
            ("https://www.stcn.com/", "首页"),
            ("https://www.stcn.com/article/list.html?type=yw", "要闻"),
            ("https://www.stcn.com/article/list.html?type=gs", "公司"),
            ("https://www.stcn.com/article/list.html?type=jj", "基金"),
        ]
        ...
        try:
            ...
            for selector in selectors:
                for el in soup.select(selector):
                    ...
                    # 提取时间
                    publish_time = None
                    time_el = soup.find("time") or soup.find("span", class_=lambda c: c and "time" in c if c else False)
                    if time_el:
