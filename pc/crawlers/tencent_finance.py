...
class TencentFinanceCrawler(BaseCrawler):
    """腾讯财经爬虫 - HTML解析"""

    def __init__(self):
        super().__init__()
        self.source_name = "腾讯财经"
        self.base_url = "https://finance.qq.com"

        self.channels = [
            ("https://finance.qq.com/", "首页"),
            ("https://finance.qq.com/stock/", "股票"),
            ("https://finance.qq.com/fund/", "基金"),
            ("https://finance.qq.com/money/", "理财"),
            ("https://new.qq.com/ch/finance/", "新闻财经频道"),
        ]
